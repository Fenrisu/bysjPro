...
<header>
<div class="container">
  <span class="text-primary h3">考证管理系统注册</span><p class="text-right">返回<a href="load.html" class="h4" style="text-decoration: none;color:#8cd5ed;">登录</a>页面</p>
</div>
</header>
<div class="container" style="margin-top:20px;">
  <div class="form-box row" id="rfrom">
    <form action="<?php echo U('Load/rigist');?>" class="form-horizontal" role="form" id="register-form" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-6 input-parent">
          <div class="form-control vinput">
          &nbsp;是&nbsp;<input type="radio" class=" " id="health" name="health" value="是"/>
          </div>
          <span></span>
        </div>
      </div>
