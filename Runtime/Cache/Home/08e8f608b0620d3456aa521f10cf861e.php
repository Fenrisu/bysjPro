  ...
  <div class="col-sm-3 s_nav">
    <div class="navMenubox">
      <div id="slimtest1">
        ...
        <ul class="navMenu">
          <li> <a href="<?php echo U('User/tongzhi');?>" class="afinve"> <i class="glyphicon glyphicon-envelope" style="line-height: 40px;"></i> <span class="">通知公告</span></a></li>
          <li> <a href="<?php echo U('User/baoming');?>" class="afinve"> <i class="glyphicon glyphicon-tag" style="line-height: 40px;"></i> <span class="">我要报名</span></a></li>
          <li > <a href="javascript:;" class="afinve"> <i class="glyphicon glyphicon-user" style="line-height: 40px;"></i> <span class="nav-text">个人信息</span> <span class="arrow"></span> </a>
            <ul class="sub-menu">
              <li><a href="<?php echo U('User/ziliao');?>" ><span>个人资料</span></a></li>
              <li><a href="<?php echo U('User/hegezheng');?>"><span>合格证</span></a></li>
              <li><a href="<?php echo U('User/gaimi');?>"><span>修改密码</span></a></li>
            </ul>
          </li>
          <li > <a href="<?php echo U('User/shenhe');?>" class="afinve"><i class="glyphicon glyphicon-check" style="line-height: 40px;"></i><span>审核状态</span></a> </li>
          <li > <a href="<?php echo U('User/printcard');?>" class="afinve"> <i class="glyphicon glyphicon-save" style="line-height: 40px;"></i> <span class="nav-text">准考证打印</span> </a></li>
          <li > <a href="<?php echo U('User/result');?>" class="afinve"> <i class="icon_3"></i> <span class="nav-text">考试结果</span></a> </li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="info col-sm-9" style="margin-top:20px;">
    <p class="alert alert-info">个人资料<span class="glyphicon glyphicon-menu-right"></span></p>
    <form action="<?php echo U('User/ziliao');?>" class="form-horizontal" role="form" id="register-form" method="post" >
      <div class="form-group">
        <label for="name" class="col-sm-2  control-label">用户名 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="name" name="name" value="<?=$account?>" disabled="true">
          <span></span>
        </div>
      </div>
      <div class="form-group">
        <label for="username" class="col-sm-2  control-label">姓 &nbsp;&nbsp;&nbsp;&nbsp; 名 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="username" name="username"  value="<?=$real_account?>" disabled="true">
          <span></span>
        </div>
      </div>
      <div class="form-group">
	    <label for="username" class="col-sm-2  control-label">性 &nbsp;&nbsp;&nbsp;&nbsp; 别 :</label>
        <div class="col-sm-10  input-parent">
         <input type="text" class="form-control vinput" id="sex" name="sex"  value="<?=$sex?>" disabled="true">
         </div>
        </div>
      ...
      <div class="form-group">
        <label for="birthday" class="col-sm-2  control-label">出生日期 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="birthday" name="birthday" value="<?=$birth?>" readonly>
          <span></span>
        </div>
      </div>
      <div class="form-group">
        <label for="card" class="col-sm-2  control-label">身份证号 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="card" name="card" value="<?=$id_card?>" disabled="true">    
          <span></span>
        </div>
      </div>
      <div class="form-group">
        <label for="position" class="col-sm-2  control-label">职 &nbsp;&nbsp;&nbsp;&nbsp; 称 :</label>
		<div class="col-sm-10  input-parent">
        <input type="text" class="form-control vinput" id="position" name="position"  value="<?=$profession?>" >
		</div>
      </div>
      <div class="form-group">
        <label for="from" class="col-sm-2  control-label">毕业院校 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="from" name="from" value="<?=$school?>">    
          <span></span>
        </div>
      </div>
      <div class="form-group">
        <label for="position" class="col-sm-2  control-label">所学专业 :</label>
        <div class="col-sm-10 input-parent">
          <input type="text" class="form-control vinput" id="major" name="major"  value="<?=$major?>" >
        </div>
      </div>
       <div class="form-group">
        <label for="position" class="col-sm-2  control-label">学 &nbsp;&nbsp;&nbsp;&nbsp; 历 :</label>
        <div class="col-sm-10 input-parent">
          <input type="text" class="form-control vinput" id="education" name="education"  value="<?=$education?>" >
        </div>
      </div>
      <div class="form-group">
        <label for="graduate" class="col-sm-2  control-label">毕业年份 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="graduate" name="graduate" value="<?=$graduate?>" readonly>
          <span></span>
        </div>
      </div>
      <div class="form-group">
        <label for="workplace" class="col-sm-2  control-label">工作单位 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="workplace" name="workplace" value="<?=$work_address?>">    
          <span></span>
        </div>
      </div>
      <div class="form-group">
        <label for="phone" class="col-sm-2  control-label">手 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 机 :</label>
        <div class="col-sm-10  input-parent">
          <input type="text" class="form-control vinput" id="phone" name="telephone" value="<?=$phone?>">    
          <span></span>
        </div>
      </div>
      <div class="form-group ">
        <label for="email" class="col-sm-2  control-label">邮 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 箱 :</label>
        <div class="col-sm-10 input-parent">
          <input type="text" class="form-control vinput" id="email" name="email" value="<?=$mail?>"/>       
          <span></span>
        </div>
      </div>
      <div class="form-group ">
        <label for="address" class="col-sm-2  control-label">通信地址 :</label>
        <div class="col-sm-10 input-parent">
          <input type="text" class="form-control vinput" id="address" name="address" value="<?=$addr?>"/>       
          <span></span>
        </div>
      </div>
