...
<div class="paiexam col-sm-9" style="margin-top:20px;">
      <ul class="list-group">
      <li class="list-group-item list-group-item-warning">合格证查询<span class="glyphicon glyphicon-menu-right"></span></li>
      </ul>
      <form action="<?php echo U('Index/checkhegezheng');?>" style="margin-left:100px;" class="form-horizontal" method="post">
        <div class="form-group">
    ...
    <table class="table" style="margin-top:35px;margin-bottom: 100px;">
	  ...
	  <?php if(is_array($hegezheng)): foreach($hegezheng as $key=>$h): ?><tr class="primary">
        <td><?php echo ($h["real_account"]); ?></td>
        <td><?php echo ($h["subject"]); ?></td>
        <td><?php echo ($h["date"]); ?></td>
        <td><?php echo ($h["time"]); ?></td>
		<td><?php echo ($h["end_date"]); ?></td>
		<td><?php echo ($h["alert_date"]); ?></td>
